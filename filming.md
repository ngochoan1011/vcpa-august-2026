# Filming Plan — VCPA Monthly Meeting & Networking, 20/08/2026

**Sự kiện:** VCPA Monthly Meeting & Networking
...
| **P2** | **Clip Joey ra mắt vai trò mới** | Ra mắt Brand Ambassador & Head of Strategic Partnerships |

> **Nguyên tắc xuyên suốt:** quay để **cắt được nhiều**, không quay để có một video đẹp. Mỗi câu trả lời phải đứng độc lập được khi tách khỏi câu hỏi.
...
| **Joey** | Brand Ambassador & Head of Strategic Partnerships | **Gương mặt thương hiệu** — networking, bắt tay, giới thiệu Wizy | Có clip ra mắt vai trò riêng. Quay Joey **đang networking thật**, không diễn |
| **Hảo** | Phụ tá | **Âm thanh + ánh sáng + hậu cần**: gắn mic, cầm đèn, clapper, ghi log take, canh pin/thẻ nhớ, giữ đồ | Vai trò quan trọng nhất mà ai cũng xem nhẹ — **âm thanh hỏng là mất trắng** |

**Ai bấm nút cuối cùng:** Annie (nội dung/kịch bản) — Phung (hình ảnh) — Hoan (thông điệp). Tránh 5 người cùng chỉ đạo.

---

## 2. ⚠️ Việc phải làm TRƯỚC — xin phép
...
## 3. Thiết bị (checklist)

**Hình:**
- [ ] Camera A (Phung) — máy chính, chân máy vững, quay full bài nói
- [ ] Camera B (Annie) — góc phụ / cận mặt / máy cầm tay
- [ ] Điện thoại làm **camera C dự phòng** — đặt cố định, quay từ đầu đến cuối, không đụng vào (đây là **bảo hiểm**)
- [ ] Chân máy ×2 + gimbal (nếu có)
- [ ] Thẻ nhớ **dư gấp đôi** dự tính + pin **dư gấp ba**

**Tiếng — quan trọng hơn hình:**
- [ ] **Lav mic không dây gắn áo Hoan** (BẮT BUỘC cho bài nói)
- [ ] Lav thứ 2 cho người phỏng vấn / Annie
- [ ] Recorder rời ghi backup (hoặc điện thoại ghi âm đặt gần bục)
- [ ] Cáp lấy line-out từ mixer hội trường (nếu có) — nguồn tiếng sạch nhất
- [ ] Pin AA/AAA cho mic, deadcat chống gió
- 🔴 **Luôn có ≥2 nguồn tiếng độc lập cho bài nói.**

**Ánh sáng:**
- [ ] 1 đèn LED nhỏ có pin + softbox/khuếch tán — cho các clip phỏng vấn (hội trường thường ánh sáng trần rất xấu, đổ bóng dưới mắt)
- [ ] Phản quang (reflector) gấp gọn

**Khác:**
- [ ] **Backdrop / roll-up Wizy** hoặc chọn sẵn một bức tường sạch làm "phông phỏng vấn" cố định
- [ ] Áo đồng phục / dress code: business casual (theo yêu cầu event) — **thống nhất tông màu cả đội**, tránh sọc nhỏ (bị nhiễu trên camera)
- [ ] Name tag Wizy cho cả 5 người
- [ ] Card visit cho Joey & Hoan (rất nhiều — đây là event networking)
- [ ] Ổ cứng / laptop để **copy dữ liệu ngay trong đêm**
- [ ] Clapper hoặc chỉ cần vỗ tay đầu mỗi take (đồng bộ tiếng)
...
- **Mỗi câu = một video độc lập.** Không nối thành một buổi phỏng vấn dài.
- **Hoan phải nhắc lại câu hỏi trong câu trả lời.** Không nói "Đúng rồi, có" — mà nói *"Wizy có ứng dụng AI vào quy trình phát triển không? Có, và nhiều hơn mọi người nghĩ…"* → clip đứng một mình được.
- **Mỗi câu quay 2 take:** 1 bản ~30s (cho TikTok/Reels/Shorts) + 1 bản ~60–90s (cho Facebook/LinkedIn/YouTube).
- **8 giây đầu là tất cả.** Bắt đầu bằng câu chốt, không bắt đầu bằng "Xin chào, tôi là…".
- Quay **cả hai khung hình: dọc 9:16 (chính) và ngang 16:9** — hoặc quay ngang 4K rồi crop dọc. Chốt trước với Phung.
- Annie đứng **sát cạnh ống kính**, Hoan nhìn vào Annie → ánh mắt tự nhiên. Hoặc nhìn thẳng camera nếu là clip "nói với khán giả".

### 4.3. Bộ câu hỏi — bản chính (Hoan yêu cầu)

Mỗi câu kèm **hook mở** + **ý cần chạm** + **người trả lời** + **độ dài**.
...
**Q2 — Khán giả của event hôm nay là ai?** · Hoan · 30s · *(tại hội trường)*
- **Hook:** "Nhìn quanh phòng này: mỗi người ở đây đang tự điều hành một doanh nghiệp."
- Chạm: chủ tiệm nail, nhà hàng, retail · CPA, real estate agent, broker, immigration consultant · điểm chung: bận, thực dụng, cần kết quả đo được.
- *Dùng để nói với người xem: "nếu bạn giống họ, clip này dành cho bạn".*

**Q3 — Anh Hoan sẽ chia sẻ gì trong buổi hôm nay?** · Hoan · 45–60s · **⭐ clip quan trọng nhất trước event**
- **Hook:** "Hầu hết mọi người ở đây đã dùng ChatGPT. Gần như không ai kiếm thêm được đồng nào từ nó. Tối nay tôi nói về khoảng cách đó."
- Chạm: **Thang 4 nấc — Assist → Automate → Agent → Advantage** · đa số đang kẹt ở nấc 1 · tiền nằm ở nấc 2–3.
- **Không tiết lộ hết.** Mục tiêu là kéo người đến, hoặc khiến người không đến được phải hỏi xin slide.

**Q4 — Đội ngũ nhân sự của Wizy đang ở đâu?** · Steve (chính) + Hoan (bổ sung) · 45s
- **Hook:** "Wizy không phải một agency một người ngồi máy tính."
- Chạm: **team Tech/AI + Operation tại Việt Nam** · **team tại Canada/GTA** phụ trách khách hàng, quay phim tại chỗ, chạy ads, báo cáo · lợi thế múi giờ — Việt Nam làm khi Canada ngủ, sáng ra khách đã có kết quả · lợi thế chi phí → *"premium in quality, competitive in price"*.
- 💡 Đây là câu **xử lý nghi ngờ ngầm** ("agency Việt Nam có đáng tin không?"). Trả lời thẳng, đừng né.

**Q5 — Wizy.ca cung cấp dịch vụ gì?** · Steve hoặc Joey · 45–60s
- **Hook:** "Chúng tôi không bán phần mềm để bạn tự làm. Chúng tôi làm thay bạn."
- Chạm: **done-for-you** · social media (~20 bài/tháng) · video (~8 clip/tháng, quay tại tiệm) · Google Maps local SEO + review · Google & Facebook Ads · web design · CRM + booking tự động · AI chatbot.
- Chốt: *"Bạn lo chuyên môn của bạn. Marketing để chúng tôi."*
- ⚠️ **Không nói giá trong clip** — để dành cho buổi tư vấn.

**Q6 — Những sản phẩm Wizy đã và đang phát triển** · Hoan · 60–90s · **hoặc tách thành 5 clip riêng** ✅
- **Hook:** "Chúng tôi không đi thuê phần mềm cho khách. Chúng tôi tự xây."
- **Đề xuất tách:** một clip tổng quan 60s + **5 micro-clip 20–30s**, mỗi sản phẩm một clip:
  - **WIZY CRM** — leads, booking, loyalty, review, POS, báo cáo trong một hệ thống; hỗ trợ AI agent qua MCP
  - **WizySalon** — cho tiệm nail chủ Việt: queue thợ, **tự chia 60/40 và tip**, lễ tân AI **nói tiếng Việt 24/7**, giao diện tiếng Việt gốc
  - **WizyFNB** — nhà hàng dine-in: POS + bàn + bếp + tồn kho; **chạy được cả khi Wi-Fi rớt**
  - **CremyX** — AI marketing platform: 30 ngày nội dung đúng brand trong 5 phút
  - **Orchexa** — nền tảng enterprise: điều phối AI agent + dữ liệu + quy trình cho doanh nghiệp lớn
- 💡 5 micro-clip này là **kho nội dung dùng được cả năm**, không chỉ cho event.
...
- ⚠️ **Dùng đúng bộ số ở [plan.md](plan.md) §3.1** — clip này và slide 16 phải khớp nhau tuyệt đối. Ai đó xem clip rồi đi nghe bài nói mà thấy số vênh là hỏng.
- Chốt: *"Chúng tôi ăn chính món mình nấu."* — đây là bằng chứng mạnh hơn mọi lời quảng cáo.

---

### 4.4. Gợi ý thêm — câu hỏi nên quay thêm

> Nhóm theo mục đích. Không cần quay hết — chọn theo thời gian có.

**🔥 Nhóm A — Kéo tương tác cao (ưu tiên quay)**
1. **"Sai lầm số 1 chủ doanh nghiệp Việt đang mắc với AI là gì?"** — Hoan. *Câu "hook" mạnh nhất trong cả bộ. Đáp: dừng ở nấc 1, tưởng dùng ChatGPT là đang làm AI.*
2. **"$2,000/tháng cho marketing — đắt hay rẻ?"** — Hoan/Steve. *Đối diện thẳng phản đối về giá: so với một nhân viên part-time, so với doanh thu một khách quay lại.*
3. **"AI có cướp việc của thợ nail / nhân viên của tôi không?"** — Hoan. *Câu cả cộng đồng đang sợ. Trả lời thật, không né.*
4. **"Tiệm tôi làm 20 năm rồi, không cần công nghệ — anh nói sao?"** — Hoan. *Format phản biện, rất dễ viral.*
5. **"Một câu cho người chủ tiệm 55 tuổi không rành công nghệ?"** — Hoan. *Chạm cảm xúc, rất "cộng đồng".*

**💙 Nhóm B — Câu chuyện & con người (nuôi lòng tin — "nurture")**
6. **"Vì sao anh bỏ vị trí kỹ sư để về làm cho tiệm nail, tiệm phở?"** — Hoan. *Đây là WHY. Có thể là clip hay nhất cả bộ.*
7. **"Wizy ra đời như thế nào?"** — Hoan + Steve quay chung. *Hai co-founder cùng khung hình rất có sức nặng.*
8. **"Thất bại lớn nhất của Wizy đến giờ là gì?"** — Hoan. ⭐ *Đúng phương pháp struggle content: bằng chứng chuyển hoá, không phải bằng chứng thành công.*
9. **"Điều gì làm anh muốn nghỉ nhất trong năm đầu?"** — Hoan. *Cùng mạch trên.*

**🤝 Nhóm C — Joey ra mắt vai trò mới**
10. **"Giới thiệu Joey — Brand Ambassador & Head of Strategic Partnerships của Wizy"** — Hoan giới thiệu + Joey nói.
11. **"Vì sao Joey chọn đồng hành cùng Wizy?"** — Joey. *Lời chứng từ người ngoài đáng tin hơn lời tự khen.*
12. **"Joey sẽ giúp gì cho doanh nghiệp muốn hợp tác với Wizy?"** — Joey. *Có CTA: nhắn Joey để nói chuyện.*
13. **B-roll bắt buộc:** Joey đang bắt tay, trao card, cười nói trong networking. *Đây là tài sản hình ảnh cho vai trò Brand Ambassador.*

**🎤 Nhóm D — Quay TẠI sự kiện (sau bài nói)**
14. **Vox-pop 3 câu với người tham dự** (xin phép trước): *"Anh/chị tâm đắc điều gì nhất tối nay?"* — bằng chứng xã hội **cực mạnh**, quý hơn mọi clip tự nói về mình.
15. **Phản ứng ngay sau khi xuống sân khấu** — Hoan, còn nguyên năng lượng, mồ hôi, thở gấp. *Rất thật, rất khó dựng lại.*
16. **Clip chung với Nam Tran** (nếu anh ấy đồng ý) — *tech + tax: hai mặt của cùng một bài toán SME.* Vừa lịch sự, vừa mở rộng tệp.
17. **Cảm ơn VCPA / Linh Ho** — quan hệ dài hạn, gần như chắc chắn được VCPA chia sẻ lại.

**📱 Nhóm E — Định dạng sáng tạo**
...
## 5. BLOCK 2 — Quay bài thuyết trình (P0)

### 5.1. Bố trí máy

| Máy | Người | Vị trí | Khung hình | Nhiệm vụ |
|---|---|---|---|---|
| **A** | Phung | Chính giữa, hơi lệch, trên tripod | Trung cảnh — Hoan + một phần màn chiếu | **Chạy liên tục, không cắt, không zoom lung tung** |
| **B** | Annie | Bên hông ~45° | Cận mặt / cận tay | Cắt xen, bắt biểu cảm. Được phép di chuyển nhưng **không đi ngang trước máy A** |
| **C** | Hảo set-up | Sau lưng khán giả, cố định | Toàn cảnh — thấy cả khán phòng | **Bảo hiểm.** Bấm quay rồi để yên |

- 🔴 **Máy A và C bấm quay TRƯỚC khi Hoan bắt đầu và chỉ dừng sau khi kết thúc Q&A.** Thẻ đầy giữa chừng = mất bài nói.
- Kiểm tra pin/thẻ ngay trước khi Hoan lên. Hảo phụ trách.

### 5.2. Âm thanh (quan trọng nhất)

1. **Lav mic gắn áo Hoan** — nguồn chính. Gắn & test **trước 6:45 PM**.
2. **Line-out từ mixer hội trường** (nếu có) → recorder rời.
3. **Điện thoại ghi âm đặt trên bục** — backup cuối cùng.
- Vỗ tay 1 cái trước khi bắt đầu → mốc đồng bộ cho khâu dựng.
- Hảo đeo tai nghe **kiểm tra tiếng lav trong suốt bài nói** — phát hiện rè/rớt sóng ngay.

### 5.3. Cảnh cần bắt (shot list)

- [ ] Hoan bước lên sân khấu / được Linh Ho giới thiệu
- [ ] Toàn cảnh khán phòng **lúc khán giả giơ tay** (khoảnh khắc mở bài — **không được bỏ lỡ**)
- [ ] Cận mặt khán giả đang gật đầu, ghi chép, cười
- [ ] Khán giả **giơ điện thoại chụp slide "Thang 4 nấc"** ← cảnh vàng, bằng chứng nội dung có giá trị
- [ ] Cận slide có số liệu lớn
- [ ] Tay Hoan diễn giải khi nói
- [ ] Q&A — người hỏi đứng lên (⚠️ chỉ đăng nếu đã xin phép)
- [ ] Tràng pháo tay cuối bài
- [ ] Người vây quanh Hoan sau bài nói ← bằng chứng xã hội mạnh nhất

### 5.4. B-roll networking (7:00–7:30 và sau 9:00)

- [ ] Bàn đăng ký, name tag, đồ ăn nhẹ
- [ ] Roll-up VCPA + roll-up/backdrop Wizy
- [ ] **Joey bắt tay, trao card, trò chuyện** (nhiều góc)
- [ ] Steve nói chuyện với chủ doanh nghiệp
- [ ] Cảnh rộng cả phòng lúc đông nhất
- [ ] Chi tiết: ly cà phê, sổ tay, bút, poster QR
- [ ] Timelapse ngắn phòng lúc đang lấp đầy *(nếu có thời gian)*

---

## 6. Call sheet — ngày 20/08/2026

| Giờ | Việc | Ai |
|---|---|---|
| **4:30 PM** | Cả đội tập trung, kiểm đồ theo checklist §3 | Tất cả |
| **5:15 PM** | Có mặt tại 3279 Lenworth Dr. Chào BTC, xác nhận lại việc quay | Tất cả |
| **5:20–5:45** | Khảo sát: chọn góc máy, chọn phông phỏng vấn, thử ánh sáng & tiếng | Phung, Hảo |
| **5:45–6:30** | **Quay Block 1** — nhóm câu về sự kiện (Q1, Q2, Q3) + clip Joey | Annie dẫn, Phung quay |
| **6:30–6:45** | Set 3 máy cho bài nói, gắn lav cho Hoan, test tiếng | Phung, Hảo |
| **6:45 PM** | 🔴 **NGỪNG QUAY HOAN.** Hoan nghỉ, xem lại slide | Hoan |
| **6:45–7:00** | Quay B-roll khách đến, bàn đăng ký, networking | Phung, Annie |
| **7:00–~7:30** | Networking — quay Joey, Steve, không khí. **Hoan đi networking, không cầm máy** | Phung, Annie |
| **~7:30** | Chương trình bắt đầu. 3 máy vào vị trí, **bấm quay** | Tất cả |
| **Bài của Hoan** | Quay full. Hảo canh tiếng | Phung, Annie, Hảo |
| **Bài của Nam Tran** | Quay nếu đã xin phép. Nếu không → nghỉ, sạc pin, đổi thẻ | Phung |
| **~9:00–9:30** | **Vox-pop khán giả** + clip phản ứng sau bài nói + cảm ơn BTC | Annie dẫn, Phung quay |
| **9:30 PM** | Thu dọn. **Đếm lại đồ theo checklist** | Hảo |
| **Trong đêm** | **Copy toàn bộ dữ liệu ra 2 nơi khác nhau** trước khi ngủ | Phung |

> ⚠️ Giờ bắt đầu bài của Hoan chưa chắc chắn — **cần hỏi Linh Ho lịch chi tiết** (ai nói trước, mỗi người bao nhiêu phút).
...
## 8. Sau sự kiện — lịch xuất bản

Áp dụng nhịp **3-1-2-1** (Attract 3 / Nurture 1 / Position 2 / Convert 1 mỗi tuần).
...
- 1 bài LinkedIn dài của Hoan
- Bộ ảnh cho hồ sơ năng lực & poster tháng sau
- Transcript → chạy qua **CremyX** để sinh loạt post đa nền tảng ← *đúng tinh thần "chúng tôi ăn chính món mình nấu"*
...
|---|---|---|
| **Mic rớt sóng / tiếng rè** | Cao | 3 nguồn tiếng độc lập. Hảo đeo tai nghe canh liên tục |
...
5. **Ai dựng video, deadline recap 48h giao cho ai?** (Annie? thuê ngoài? team Việt Nam?)
6. **Clip ra mắt Joey đăng khi nào** — trước event (tạo tò mò) hay sau event (kèm hình networking thật)?
7. **Chọn bao nhiêu câu trong Nhóm gợi ý §4.4?** — đề xuất tối thiểu: #1, #6, #8, #10, #14.
8. **Ngân sách thuê thêm đèn/mic** nếu thiết bị hiện có chưa đủ?
